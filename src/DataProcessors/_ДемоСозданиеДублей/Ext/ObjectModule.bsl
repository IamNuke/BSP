...
Функция СоздатьДублиИспользующиесяВРегистрахСведений(Настройки, Результат)
	...
	// На базе регистра _ДемоРаботникиОрганизаций тестируется все подмножество вариантов:
	...
	Для НомерЭлемента = 1 По Настройки.РегистрыСведенийКоличество Цикл
		...
		СсылкиФизическихЛиц.Добавить(Оригинал);
		СсылкиФизическихЛиц.Добавить(Дубль);
