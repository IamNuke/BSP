...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПозиционированиеНаРазделе Тогда
		ПереключитьВидимостьГруппТелаАнкеты();
	КонецЕсли;
...
Процедура ПереключитьВидимостьГруппТелаАнкеты()
	
	Элементы.ГруппаТелоАнкеты.Видимость = НЕ Элементы.ГруппаТелоАнкеты.Видимость;
	Элементы.ГруппаОжидание.Видимость = НЕ Элементы.ГруппаТелоАнкеты.Видимость;
